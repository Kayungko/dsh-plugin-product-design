...
- Shortcut artifacts: flag generic rounded cards, unnecessary borders, decorative CSS blobs, fake SVG illustrations, half-built avatars, mismatched hero art, and custom CSS/SVG replacements where the target called for real imagery, real icons, or a different surface treatment.
...
- Cramped text, broken wrapping, mismatched font weights, bad line height, or awkward letter spacing when they affect readability or hierarchy.
...
- Broken icons, custom SVGs, half-built attempts at avatars, hero art mismatches, custom CSS art, and placeholder-looking sourced assets.
