...
- Description: Design files, component libraries, prototypes, whiteboards, or other design-tool sources and frame links.
...
- Description: Preferred browser, capture tool, design-tool usage, share target, deployment target, and team workflow preferences.
